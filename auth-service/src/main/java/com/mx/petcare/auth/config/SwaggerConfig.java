...
public class SwaggerConfig {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("PetCare Auth-Service API")
                        .version("auth-service-0.0.1-SNAPSHOT")
                        .description("This service is responsible for handling authentication and authorization processes for the PetCare platform. It supports user and veterinarian login, JWT generation, and token validation.")
                        .contact(new Contact()
                                .name("Jacito")
                                .email("jacitojvb@gmail.com")
                                .url("https://github.com/jacito/petcare-auth-service")))
