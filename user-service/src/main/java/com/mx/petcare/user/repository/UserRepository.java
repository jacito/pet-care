...
public interface UserRepository extends JpaRepository<UserPetCare, Long> {
    Optional<UserPetCare> findByUsername(String username);

    boolean existsByUsername(String username);
    List<UserPetCare> findByRole(String role);
