...
@Data
@AllArgsConstructor
@Schema(description = "Detailed view of a pet and its assigned veterinarian")
public class PetVetDetailView {

    @Schema(description = "Detailed pet info")
    private PetDetailView petDetailView;

    @Schema(description = "Detailed vet info")
    private VetDetailView userDetailView;
}
